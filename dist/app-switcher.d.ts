...
import { type AppRegistryEntry, type PulseAppId, type RoleOrPermissions } from "@everybenefits/shared";
...
export declare function AppSwitcher({ current, permissions, resolveSwitchUrl, renderTriggerIcon, HomeLink, }: AppSwitcherProps): import("react").JSX.Element;
