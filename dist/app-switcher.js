...
function AppSwitcher({ current, permissions, resolveSwitchUrl, renderTriggerIcon, HomeLink, }) {
    ...
    const apps = (0, react_1.useMemo)(() => (0, shared_1.listVisibleApps)(permissions), [permissions]);
